...
public class Draw {
    ...
    public JPanel dc1(Calculator calc) {
  	...
  	public JPanel dc3(Calculator calc) {
        ...
        JButton btnc3savef = new JButton("Save");
        btnc3savef.addActionListener(calc);
        btnc3savef.setActionCommand("SaveFileCard3");
  	...
  	public JPanel dc4(Calculator calc) {
        ...
        calc.textc4.addKeyListener(calc);
        ...
        JButton btnc4savef = new JButton("Save");
        btnc4savef.addActionListener(calc);
        btnc4savef.setActionCommand("SaveFileCard4");
