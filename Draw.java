...
public class Draw {
    ...
    public JPanel dc1(Calculator calc) {
  	...
  	public JPanel dc2(Calculator calc) {
        ...
        JButton btnrevn = new JButton("revn");
        btnrevn.addActionListener(calc);
        btnrevn.setActionCommand("revn");
        JButton rinf = new JButton("rinf");
